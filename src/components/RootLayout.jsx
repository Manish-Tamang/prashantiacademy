    ...
    <Container>
      <div className="flex items-center justify-between">
        ...
        <Link href={"/"} aria-label="Home">
          <Logo invert={invert}>Prashati Academy
          </Logo>
        </Link>
...
const Navigation = () => {
  return (
    <nav className="mt-px font-sans text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/about">About Us</NavigationItem>
        <NavigationItem href="/gallery">Gallery</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/News">News and Events</NavigationItem>
